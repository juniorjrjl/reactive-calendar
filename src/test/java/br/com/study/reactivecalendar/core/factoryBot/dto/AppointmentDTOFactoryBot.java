...
public class AppointmentDTOFactoryBot {

    public static AppointmentDTOFactoryBotBuilder builder(){
        return new AppointmentDTOFactoryBotBuilder();
    }

    public static class AppointmentDTOFactoryBotBuilder{
        ...
        private final Set<GuestDTO> guests;
        private final OffsetDateTime createdAt;
        private final OffsetDateTime updatedAt;
        private final Faker faker = getFaker();

        public AppointmentDTOFactoryBotBuilder() {
        ...
        private Set<GuestDTO> generateGuests(final int amount){
            return Stream.generate(() ->  GuestDTO.builder().userId(ObjectId.get().toString())
